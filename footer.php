			...
			<div class="container-fluid">
                <div class="row justify-content-center">
                	<div class="col-12 col-md-9 col-8 text-center">
                		...
                		<p class="ss-copyright">&copy;&nbsp;<?php echo date('Y'); ?> Sort & Survive Ltd - Limited Company registered in England and Wales (Company number 16026311). All rights reserved.</p>
                	</div>
                </div>
            </div>
		</footer>
